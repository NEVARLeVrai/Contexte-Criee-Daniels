...
<body>
    <section id="connexion_et_inscription" class="connexion_et_inscription">
        ...
        if (!isset($_SESSION['identifiant'])) {
            ...
            // L'utilisateur est connecté, permettre l'accès à la création de lots
            ...
            <label for="dateEnchere">Date d'enchère :</label><br>
            <input type="date" id="dateEnchere" name="dateEnchere" required><br><br>

            <label for="heureDebutEnchere">Heure de début d'enchère :</label><br>
            <input type="time" id="heureDebutEnchere" name="heureDebutEnchere" required><br><br>
